...
- **Реестр диалектов**: для каждого MLIR-слоя/файла объявлять диалект (в атрибутах модуля или в `.cursor/artifacts_mlir_graphdb/mlir/README.md`; см. также `docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/README.md`).
