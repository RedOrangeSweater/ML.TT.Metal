...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#intro] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#intro_chain] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#doc_layer] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#mlir_doc_layer] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#mlir_passes] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#graphdb] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#next_mlir] dialect=ttm.sdlc_doc -->
...
<!-- mlir: docs/sdlc/00_Main/02_Architecture/Artifacts/mlir/doc_pipeline.mlir [#final_llm] dialect=ttm.sdlc_doc -->

---

## 3. Правила ведения

- **После каждого абзаца/раздела**: сноска в едином формате (HTML-комментарий или markdown-сноска): путь к MLIR, опционально якорь, диалект. Пример: `<!-- mlir: path/to/file.mlir [#anchor] dialect=ttm.sdlc_doc -->`.
- **Реестр диалектов**: для каждого MLIR-слоя/файла объявлять диалект (в атрибутах модуля или в этом каталоге `Artifacts/mlir/README.md`).
