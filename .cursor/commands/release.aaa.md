...
Опционально: релиз (`REL-*` или путь), подпроект (`apps/<name>/`, `packages/<name>/`), пожелания по UX. **Пусто** → фокус из tt-lang `docs/sdlc/01_tt_metal/00_Status/00_projects_graph.md`, `01_Kanban.md`; ближайший `REL-*` в `docs/**`.
...
1. SoT + цель релиза: `docs/README.md`, tt-lang `docs/sdlc/01_tt_metal/00_Status/00_projects_graph.md`, `01_Kanban.md`, `REL-*`.
